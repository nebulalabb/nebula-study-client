...
import { CheckCircle2, ChevronRight, User, BookOpen, Calendar as CalIcon, Sparkles, Rocket, ArrowLeft, Heart, Award } from 'lucide-react';
             ...
             <div className="space-y-10 animate-in fade-in slide-in-from-right-8 duration-500">
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative max-w-md">
                    <input 
                      ...
                      value={formData.hourly_rate_vnd} onChange={e => updateForm('hourly_rate_vnd', Number(e.target.value))}
                    />
                ...
                <div className="space-y-3">
                  ...
                  <textarea 
                    ...
                    value={formData.teaching_style} onChange={updateForm.bind(null, 'teaching_style')}
                  />
